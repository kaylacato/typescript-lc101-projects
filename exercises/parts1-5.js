...
console.log("".concat(spacecraftName, " will take ").concat(daysToMars, " to arrive at Mars."));
...
console.log("It will take ".concat(spacecraftName, " ").concat(getDaysToLocation(kilometersToTheMoon), " days to get to the moon "));
